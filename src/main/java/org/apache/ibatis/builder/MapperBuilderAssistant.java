...
public class MapperBuilderAssistant extends BaseBuilder {
    ...
    public MappedStatement addMappedStatement(
        ...
        statementBuilder.encryType(encryType);
    ...
    public MappedStatement addMappedStatement(
            ...
            LanguageDriver lang,
            String resultSets) {
        return addMappedStatement(id, sqlSource, statementType, sqlCommandType,
                fetchSize, timeout, parameterMap, parameterType, false, resultMap, resultType,
                resultSetType, flushCache, useCache, resultOrdered,
                keyGenerator, keyProperty, keyColumn, databaseId, lang, resultSets);
    }
